  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      child: Column(
        ...
        children: [
          Image(image: AssetImage("assets/ownlogo.png") , height: height * 0.6,),
          Text(
            "Favourite movie ticket",
            style: Theme.of(context).textTheme.headline3,
          ),
          Text("Dive into a new adventure with Poppin Road Cinema" , 
          ...
          Row(
            children: [
              ...
              SizedBox(width: 10,),
              Expanded(child: ElevatedButton(onPressed: () {}, child: Text("Sign up " .toUpperCase() 
